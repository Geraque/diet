...
public class AuthController {
  ...
  public ResponseEntity<Object> registerUser(@Valid @RequestBody SignupRequest signupRequest,
    ...
    userService.create(signupRequest, ERole.ROLE_USER);
  ...
  public ResponseEntity<Object> registerAdmin(@Valid @RequestBody SignupRequest signupRequest,
    ...
    userService.create(signupRequest, ERole.ROLE_ADMIN);
    return ResponseEntity.ok(new MessageResponse("User registered successfully!"));
  }

  @PostMapping("/addDiet")
  public ResponseEntity<Object> registerDiet(@Valid @RequestBody SignupRequest signupRequest,
      BindingResult bindingResult) {
    ResponseEntity<Object> errors = responseErrorValidation.mapValidationService(bindingResult);
      if (!ObjectUtils.isEmpty(errors)) {
          return errors;
    ...
    userService.create(signupRequest, ERole.ROLE_DIET);
    return ResponseEntity.ok(new MessageResponse("User registered successfully!"));
  }
